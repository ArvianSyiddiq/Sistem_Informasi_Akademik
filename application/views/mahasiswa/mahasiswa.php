  ...
  <section class="content">
    ...
    <div class="container mt-5">
      ...
      <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
          ...
          <a class="btn btn-danger" href="<?php echo site_url('DataMahasiswa/print'); ?>"
            style="display: inline-flex; align-items: center;">
            <i class="fa fa-print" style="margin-right: 5px;"></i> Print
          </a>
          <a class="btn btn-info" href=" <?php echo site_url('DataMahasiswa/tampil_grafik') ?>">
          ...
          <div class="dropdown d-inline">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenu1">
              <a class="dropdown-item" href="<?php echo site_url('DataMahasiswa/exportPDF'); ?>">PDF</a>
              <a class="dropdown-item" href="<?php echo site_url('DataMahasiswa/exportExcel'); ?>">Excel</a>
            </div>
          </div>
        </div>

        <div class="navbar-form">
          <?php echo form_open('DataMahasiswa/search'); ?>
        ...
        <tbody>
          ...
          <?php foreach ($mahasiswa as $mhs): ?>
            <tr>
              ...
              <td><?php echo isset($mhs['nama_jurusan']) ? $mhs['nama_jurusan'] : 'N/A'; ?></td> <!-- Display nama_jurusan if set -->
              ...
              <td>
                <?php echo anchor('DataMahasiswa/detail/' . $mhs['nim'], '<div class="btn btn-success btn-sm"><i class="fa fa-search-plus"></i></div>'); ?>
              </td>
              <td onclick="return confirm('Anda yakin ingin Hapus?')">
                <a href="<?php echo site_url('DataMahasiswa/hapus/' . $mhs['nim']); ?>" class="btn btn-danger btn-sm">
                  <i class="fa fa-trash"></i>
                </a>
              </td>
              <td>
                <a href="<?php echo site_url('DataMahasiswa/edit/' . $mhs['nim']); ?>" class="btn btn-primary btn-sm">
    ...
    <div class="modal fade" id="myModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <form action="<?php echo site_url('DataMahasiswa/add'); ?>" method="post" enctype="multipart/form-data">
    ...
    <script>
        $(document).ready(function() {
            $('#example1').DataTable();  // Initialize DataTable with default settings
        });
    </script>
  </section>
</div>
